...
# Path to your oh-my-zsh installation.
  export ZSH=/home/mraddadi/.oh-my-zsh
...
plugins=(git common-aliases django git-extras jsontools pip python pylint sudo systemd urltools virtualenvwrapper web-search wd node npm bundler)
...
export GOPATH=/home/mraddadi/golang

export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/home/mraddadi/.vimpkg/bin
...
alias k8='kubectl'
alias slackdark='cat ~/slack_dark_theme.js >> /usr/lib/slack/resources/app.asar.unpacked/src/static/ssb-interop.js'
